...
export class InMemoryDatabase implements InMemoryDbService {
    ...
    createDb(){
        ...
        const entries: Entry[] = [
            ...
            { id: 3, name: 'Sálario da Empresa X', categoryId: categories[3].id, category: categories[3], paid: true, date: "15/10/2018", amount: "4405,49", type: "revenue" } as Entry,
            ...
            { id: 5, name: 'Suplmentos', categoryId: categories[1].id, category: categories[1], paid: true, date: "17/10/2018", amount: "30,00", type: "expense" } as Entry,
            { id: 6, name: 'Video Game', categoryId: categories[2].id, category: categories[2], paid: false, date: "17/10/2018", amount: "15,00", type: "revenue" } as Entry,
        ];
